...
export const BookInventory = withRouter(( props:BookInventoryProps ) => {
  console.log(props);
  const { history } = props;
  ...
  return (
      <div>
          ...
          <Navbar/>
                  ...
                  <Button className={classes.toolbar_button} onClick={handleDialogClickOpen}>Create New Book</Button>
